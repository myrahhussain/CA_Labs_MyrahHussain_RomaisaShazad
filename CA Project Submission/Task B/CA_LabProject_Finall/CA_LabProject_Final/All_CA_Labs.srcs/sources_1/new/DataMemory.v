...
//    // Word being addressed and byte offset within it
//    wire [31:0] word = memory[address[9:2]];
//    wire [1:0]  boff = address[1:0];
...
//        // Select addressed halfword
//        h = boff[1] ? word[31:16] : word[15:0];

//        if (memRead) begin
//            case (funct3)
//                3'b000: readData = {{24{b[7]}},  b};    // LB  signed
//                3'b001: readData = {{16{h[15]}}, h};    // LH  signed
//                3'b010: readData = word;                 // LW
//                3'b100: readData = {24'b0, b};           // LBU unsigned
//                3'b101: readData = {16'b0, h};           // LHU unsigned
//                default: readData = word;
//            endcase
//        end else begin
//            readData = 32'b0;
